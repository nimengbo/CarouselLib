...
public class OldHorizontalListView extends AdapterView<ListAdapter> {
    ...
    public OldHorizontalListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    ...
    private DataSetObserver mDataObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            synchronized (OldHorizontalListView.this) {
                mDataChanged = true;
            }
            invalidate();
            requestLayout();
...
//        scaleChild();
    ...
    private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onDown(MotionEvent e) {
            return OldHorizontalListView.this.onDown(e);
        }

        @Override
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                               float velocityY) {
            return OldHorizontalListView.this.onFling(e1, e2, velocityX, velocityY);
        }
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2,
            ...
            synchronized (OldHorizontalListView.this) {
                ...
                //方便监听停止滚动
                OldHorizontalListView.this.onFling(e1, e2, 0, 0);
            }
            return true;
        }
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (isEventWithinView(e, child)) {
                    if (mOnItemClicked != null) {
                        mOnItemClicked.onItemClick(OldHorizontalListView.this, child, mLeftViewIndex + 1 + i, mAdapter.getItemId(mLeftViewIndex + 1 + i));
                    }
//                    setSelection(mLeftViewIndex + 1 + i);
                    if (mOnItemSelected != null) {
                        mOnItemSelected.onItemSelected(OldHorizontalListView.this, child, mLeftViewIndex + 1 + i, mAdapter.getItemId(mLeftViewIndex + 1 + i));
                    }
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (isEventWithinView(e, child)) {
                    if (mOnItemLongClicked != null) {
                        mOnItemLongClicked.onItemLongClick(OldHorizontalListView.this, child, mLeftViewIndex + 1 + i, mAdapter.getItemId(mLeftViewIndex + 1 + i));
                    }
                    break;
                }
